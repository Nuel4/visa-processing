<%-- 
    ...
    Created on : 8 Feb, 2019, 12:15:18 PM
    Author     : Admin
--%>
...
<td><a href="index.html"> <i>Education & Culture</i></a></td></tr>
        ...
        <h1 class="wel"> COLUMBIA UNIVERSITY!</h1>
    <form method="post" action="AdminAssess.jsp">
          
        <table align="left" border="0">
            <h2><b>Search For Applicant</b></h2>
            <tr>
                <td><h3><i><b>APPLICANT'S REG NUMBER:</b></i></h3></td><br>
           
            <td><input type="text" name=userReg size=10 ></td><br>
            </tr>
