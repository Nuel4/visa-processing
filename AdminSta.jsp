<%-- 
    Document   : AdminSta.jsp
    Created on : 25 Feb, 2019, 8:48:42 PM
    Author     : Admin
--%>
...
h1{color: brown;align-items: center;}
...
if(a.equals("1"))
{
   ...
   if(rs.next())
   {
       out.print("<h1>Congratulations! Visa is Approved</h1>");
       
   }
   else
   {
        out.print("<h1>Applicantion is rejected,Visa denied</h1> ");
   }
}
else
{
