<%-- 
    Document   : AdminVisaselect.jsp
    Created on : 26 Feb, 2019, 2:02:30 PM
    Author     : Admin
--%>
 ...
 <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js" ></script>  
    ...
    <ul style="list-style-type:none;  display:flex; justify-content: space-between; width:40%" >
        ...
        <a href="index.html"> <i class="fa fa-search"></i></a>
         <h3 class="bn" align="right"> <a href="AdminAssess.jsp"  style="color:red; font-size: 30px; text-decoration: none; "><=</a></h3>
...
rs=stmt.executeQuery("select  *  from enrolldb  where regno= "+tregno );
if (rs.next())
{
status =rs.getString(28);
//status1 =rs.getString(29);
status2=rs.getString(31);
         if((status.equals("ACCEPT")) && (status2.equals("ACCEPT")))
                  
         {
          out.println("<b> Apllicantion is successful.</b>");
         }
}
else
{
out.println("<b>Visa is declined.</b>");
}
