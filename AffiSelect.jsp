<%-- 
    Document   : AffiSelect.jsp
    Created on : 20 Feb, 2019, 7:13:24 PM
    Author     : Admin
--%>
...
.afd{margin-top: 40px; align-content: center; font-family: sans-serif;font-size: 25px; margin-bottom: 70px;color: brown; padding-top: 25px; display: ruby-base;}
    ...
    <ul style="list-style-type:none;  display:flex; justify-content: space-between; width:40%" >
        ...
        <div class="itm">
          ...
          <tr>
                      ...
                      <td> <a href="index.html"><i>Columbia Citizens Service</i></a></td>
...
rt=stmt.executeQuery("select  *  from affidat where regno= "+tregno);
...
<body bgcolor="">
    ...
    <h3 class="afd"><b><i>AFFIDAVIT DETAILS</i></b></h3>
<form method="post">
    <center><table border="0" width="570">
            <tr>
<td><b><i>Registered No:</b></i></td>
<td><input type=text name=no size="10"  disabled  value=<%= rt.getInt("regno") %> ></td>
</tr>
<tr>
<td><b><i>Registration Number:</b></i></td>
<td><input type=text name=nu size="10"  disabled  value=<%= tregno %> ></td>
</tr>
<tr>
<td><b><i>Sponsor's Name:</b></i></td>
<td><input  type=text  name=bnam size="20" disabled value=<%= rt.getString("name") %>></td>
</tr>
<tr>
<td><b><i>Address:</b></i></td>
<td><input  type=text  name=ad size="15" disabled value=<%= rt.getString("add") %>></td>
</tr>
<tr>
<td><b><i>Relationship:</b></i></td>
<td><input  type=text  name=rel size="10" disabled value=<%= rt.getString("rel") %>></td>
</tr>
</table>
<table border="0" width="475">
<tr>
<td><b><i>Location:</b></i></td>
<td><input type=text name=loc  size="10" disabled value=<%= rt.getString("location") %>></td>
</tr>
<tr>
<td>Place Of Affidavit </td>
<td><input type=text name=pln  size="15" disabled value=<%= rt.getString("institution") %>></td>
</tr>
<tr>
<td>Year </td>
<td><input type=text name=yr  size="15" disabled value=<%= rt.getString("year") %>></td>
</tr>
</table>
