<%-- 
    Document   : AffiSubmit.jsp
    Created on : 16 Feb, 2019, 2:21:30 PM
    Author     : Admin
--%>
...
.af{margin-top: 40px;font-family: sans-serif;font-size: 30px; margin-bottom: 70px;color: brown; padding-top: 30px; display: ruby-base;}
...
<td><a href="index.html"> <i>Education & Culture</i></a></td></tr>
        ...
        <h1 class="af" align="center">AFFIDAVIT DETAILS!</h1>
        
        <form method="post" action="AffiConfirmed.jsp">
            <table align= center border="0">
                ...
                <tr>
<td><b><i>Name Of The Sponsor: *</b></i></td>
<td><input type=text name=sp size="20" /></td>
</tr>
<tr>
<td><b><i>Address Of Sponsor:*</b></i></td>
<td><input type=text name=add size="20" /></td>
</tr>
<tr>
<td><b><i>Relationship: *</b></i></td>
<td><input type=text name=relate size="20" /></td>
</tr>
    <tr>
<td><b><i>Location: *</b></i></td>
<td><input type=text name=loca size="20" /></td>
</tr>  
<tr>
<td><b><i>Affidavit Institution: *</b></i></td>
<td><input type=text name=inst size="20" /></td>
</tr>
