<%-- 
    Document   : AutoIncreament.jsp
    Created on : 11 Feb, 2019, 12:43:31 PM
    Author     : Admin
--%>
...
ResultSet rs=stmt.executeQuery("select  max(regno) from del");
...
else
{
    num=0;
        ...
        <form method="post" action="AutoIncreast2.jsp">
            <label>Regno</label>
            <input type="text" name="txt" readonly value="<%=num%>"><br>
             <label>Gname</label>
