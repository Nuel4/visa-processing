<%-- 
    Document   : AutoIncreast2.jsp
    Created on : 11 Feb, 2019, 12:54:11 PM
    Author     : Admin
--%>
 ...
 <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js" ></script>  
    ...
    <ul style="list-style-type:none;  display:flex; justify-content: space-between; width:40%" >
       ...
       <a href="index.html"><i class="fa fa-plus-square"></i>
        ...
        <%
            String na=request.getParameter("txt");
             String gi=request.getParameter("name"); 
...
String  query ="insert into del(regno,name,pass) values ("+na+" ,'"+gi+"','"+pa+"')";
stmt.execute(query);
            ...
            <%
                 ...
                 <body>
                     <form>
                         <table>
                            <td>id:</td>
                            <td><input type="text" name="nam" disabled  value="<%=na %>" > </td>
                            <td>Given Name:</td>
                            <td><input type="text" name="given" disabled  value="<%=gi %>" > </td>
                            <td>DOB:</td>
                           
                            <td><input type="text" name="birth" disabled  value="<%=pa %>" > </td>
                         </table>
                     </form>
                         <%
