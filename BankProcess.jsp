<%-- 
    Document   : BankProcess.jsp
    Created on : 15 Feb, 2019, 1:52:00 PM
    Author     : Admin
--%>
        ...
        <%!
            ...
            %>
                ...
                <%
                    try
                    {
                        pas = Integer.parseInt((String) session.getAttribute("log"));
                        
                        Class.forName("com.mysql.jdbc.Driver");
                        con = DriverManager.getConnection("jdbc:mysql://localhost:3306/columbiacollege", "root", "root");
                        st=con.createStatement();
                        re=st.executeQuery("select * from enrolldb where regno = "+pas+"");
                        out.print(pas);
                        if(re.next())
                        {
                            status = re.getString(28);
                            ...
                            if(status.equals("DECLINE"))
                            {
                                ...
                                {
                                    out.print("<br> OFFER UNDER PROCESSING! SUBMIT LATER!! <br> ");
