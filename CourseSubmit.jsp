<%-- 
    Document   : OfferAccept.jsp
    Created on : 9 Feb, 2019, 11:22:52 PM
    Author     : Admin
--%>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.7/umd/popper.min.js"></script>
 <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js" ></script>  
    ...
    <h1><b><a href="index.html">OFF</a></b></h1>
               ...
               String dura=request.getParameter("duration");
                String ielt=request.getParameter("ielts");
                        ...
                        try
                 {
                     ...
                     String query = "insert into personal(course,cert,english,ielts,period,result,score,rname,relate,addr,ph,office,offad) values ('"+cos+"','"+level+"','"+eng+"','"+dura+"','"+ielt+"','"+opt+"','"+mark+"','"+rel+"','"+relation+"','"+ad+"','"+phone+"','"+wok+"','"+offi+"')";
                  sta.execute(query);
