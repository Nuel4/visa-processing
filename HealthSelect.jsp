<%-- 
    Document   : HealthSelect.jsp
    Created on : 20 Feb, 2019, 8:20:01 PM
    Author     : Admin
--%>
...
.fm{margin-top: 40px;font-family: sans-serif;font-size: 25px; margin-bottom: 70px;color: black; padding-top: 25px; display: ruby-base;}
.ht{margin-top: 40px;font-family: sans-serif;font-size: 25px; margin-bottom: 70px;color: brown; padding-top: 25px; display: ruby-base;}
...
rs=stmt.executeQuery("select  *  from health where regno= "+tregno);
...
<h3 class="ht" align="center"><b><i>Health</i></b></h3>
<form class="fm" method=post action="">
    <center><table border="0">
            <td><b><i> Reg Number:</b></i></td>
<td><input type=text name=hrg size="10"  disabled  value=<%=rs.getString("regno") %> ></td>

</tr>
<tr>
<td><b><i> Health Number:</b></i></td>
<td><input type=text name=hrg size="10"  disabled  value=<%= tregno %> ></td>
</tr>
<tr>
<td><b><i>Panel Hospital Name:</b></i></td>
<td><input type=text name=hospital size="20" disabled value=<%= rs.getString("hospital") %>></td>
</tr>
<tr>
<td><b><i> Hospital Location:</b></i></td>
<td><input type=text name=hosp size="20" disabled value=<%= rs.getString("location") %>></td>
</tr>

<tr>
<td><b><i>Panel Doctor's Name:</b></i></td>
<td><input type=text name=doctor size="20" disabled value=<%= rs.getString("doctor") %>></td>
</tr>
<tr>
<td><b><i>Health Status:</b></i></td>
<td><input type=text name=he size="20" disabled value=<%= rs.getString("healthstatus") %>></td>
</tr>
</table>
<table border="0" width="500">
<tr>
<td><b><i>Month Of Visit</b></i></td>
<td><input type=text name=heam size="15" disabled value=<%= rs.getString("month") %>></td>
</tr>
<tr>
<td> Year</td>
<td><input type=text  name=healtyear size="4" disabled value=<%= rs.getString("year") %>></td>
</tr>
...
%><center>
<p>
<b>Above are the Subitted Data.</b>
</center>
    </body>
</html>
