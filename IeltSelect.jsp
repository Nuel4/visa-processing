<%-- 
    Document   : IeltsSelect.jsp
    Created on : 20 Feb, 2019, 4:33:04 PM
    Author     : Admin
--%>
...
<html>
    <head>
        ...
        <title>IELTS INFORMATION PAGE</title>
    <style type="text/css">
            body{
                margin: 0;
...
.ilt{margin-top: 40px;color: brown; font-family: sans-serif;font-size: 30px; padding-top: 20px; margin-bottom: 30px;}
.h2{margin-top: 50px;font-size: 15px;color: brown;}
        </style>
...
rs=stm.executeQuery("select * from ieltsdb where regno= "+tregno);
...
<center><b><h3 class="ilt">IELTS Test Details</h3></b></center>
                    <form method="post">
                        ...
                        <center>  
                            ...
                            <tr>
           <td><b><i>Exam Id</b></td>
<td><input type="text"  name=xa  size="10" disabled value=<%= rs.getString("iregno") %>></td>
</tr>
<tr>
