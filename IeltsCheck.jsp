<%-- 
    Document   : IeltsView1
    Created on : 15 Feb, 2019, 2:53:22 PM
    Author     : Admin
--%>
...
<html>
    <head>
        ...
        <title>Ielts Confirmation page</title>
    <style type="text/css">
            body{
                margin: 0;
        ...
        <%
            ...
            <%
                    try
                    {
                        ...
                        kp = DriverManager.getConnection("jdbc:mysql://localhost:3306/columbiacollege", "root", "root");
                        sta=kp.createStatement();
                        su=sta.executeQuery("select * from enrolldb where regno = "+pd+"");
                        if(su.next())
                        {
                            ieltst = su.getString(28);
                             

                            if(ieltst.equals("DECLINE"))
                            {
                                out.print("<br> OFFER DECLINED! YOUR APPLICATION HAS BEEN REJECTED!! ");
                            }
                            else
                                if(ieltst.equals("processing"))
                                {
                                    out.print("<br> OFFER IS UNDER PROCESSING! SUBMIT LATER!! <br> ");
                            ...
                            else
                                {
                                    ...
                                    response.sendRedirect("IeltsForm.jsp");
