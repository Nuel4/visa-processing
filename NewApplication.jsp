<%-- 
    ...
    Created on : 8 Feb, 2019, 8:03:13 AM
    Author     : Admin
--%>
...
<html>
    <head>
        <title>Mountain Top University</title>
    <style type="text/css">
            body{
                margin: 0;
...
<td><a href="index.html"> <i>Education & Culture</i></a></td></tr>
    ...
    <body bgcolor="aaccad">
        ...
        <form method="post" action="UsersCheck.jsp">
            <font size=7>
            <br><br>
            
            NEW APPLICANT: <a href="TermsConditions.jsp"><font color=brown >LOGIN HERE</font></a>
            </font>
            <table>
                <tr>
                <br><br><br>
                ...
                <tr>
                    <td>REG NUMBER</td>
                    <td><input type="text" name=userReg size=10 ></td>
                <tr>
                    <td> PASSWORD </td>
