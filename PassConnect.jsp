<%-- 
    Document   : PassConnect.jsp
    Created on : 16 Feb, 2019, 6:55:11 PM
    Author     : Admin
--%>
...
<td><a href="index.html"> <i>Education & Culture</i></a></td></tr>
        ...
        <h1>Passport Confirmation</h1>
        <% int pss;
        int k;
            %>
            <%
       pss= Integer.parseInt((String)(session.getAttribute("log")));
           try
           {
                       ...
                       ResultSet rd = stt.executeQuery("select * from enrolldb where regno ="+pss+"");
                       String stat,stat1,stat2;
                        if(rd.next())
                        {
                            stat=rd.getString(28);
                          
                            if(stat.equals("DECLINE"))
                            {
                                out.print("<br>OFFER DECLINED! YOUR APPLICATION IS REJECTED <br>");
                            ...
                            else
                            {
                                ...
                                {
                                    out.print("<br>OFFER IS BEING PROCESSED! SUBMIT LATER<br>");
                                }
                                else
                                {
