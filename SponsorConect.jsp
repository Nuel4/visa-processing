<%-- 
    Document   : SponsorConect.jsp
    Created on : 16 Feb, 2019, 4:35:06 PM
    Author     : Admin
--%>
...
<td><a href="index.html"> <i>Education & Culture</i></a></td></tr>
        ...
        <h1>SPONSORSHIP VERIFICATION</h1>
        <%int pw;
        int vt;
        Connection con;
        Statement stmt;
        ResultSet stt;
          ...
          <%
              try
              {
                  pw= Integer.parseInt((String) session.getAttribute("log"));
                  
                    Class.forName("com.mysql.jdbc.Driver");
                  con  = DriverManager.getConnection("jdbc:mysql://localhost:3306/columbiacollege","root","root");
                   stmt = con.createStatement();
                   stt =stmt.executeQuery("select * from enrolldb where regno = "+pw+"");
                   String status;
                   if(stt.next())
                   {
                       status =stt.getString(28);
                       
                        if(status.equals("DECLINE"))
                       {
                           out.print("<br> Offer is declined !Admission is not granted <br>");
                       ...
                       else
                       {
                           ...
                           {
                               out.print("Your application is under consideration.please check later");
                           }
                           else
                           {
                               response.sendRedirect("SponsorF.jsp");
                           }
                       }
                   }
