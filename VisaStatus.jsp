<%-- 
    Document   : VisaStatus.jsp
    Created on : 20 Feb, 2019, 8:00:41 AM
    Author     : Admin
--%>
    ...
    <ul style="list-style-type:none;  display:flex; justify-content: space-between; width:40%" >
       ...
       <a href="index.html"><i class="fa fa-plus-square"></i>
        ...
        <%
            ...
            %>
            <%
              pass = Integer.parseInt((String) session.getAttribute("log"));
                ...
                ResultSet rt = st.executeQuery("select * from enrolldb where regno = "+pass+"");
                  ...
                  if(rt.next())
                  {
                      ...
                      {
                          out.print("<br> DECLINED ! Your application has been rejected . Check later !!<br>");
                      }
                      else 
                      {
                          if(status.equals("processing"))
                          {
                              out.print("<br> Your application is under processing <br>");
