<%-- 
    Document   : adminielt.jsp
    Created on : 12 Mar, 2019, 2:34:20 PM
    Author     : Admin
--%>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.7/umd/popper.min.js"></script>
       ...
       <a href="index.html"><i class="fa fa-plus-square"></i>
        ...
        <%!
            ...
            <%
               ...
               // trgno = Integer.parseInt((String) session.getAttribute("log"));
                %>
            <%
 ...
 rs=stmt.executeQuery("select  * from ieltsdb where regno= "+trgno+"");
 String ty;
 {
     if(rs.next())
     {
...
Accept<td><input type="radio" name="td" value="1">
Reject <td><input type="radio" name="td" value="1">
          </form>
<%               
         }
         %>
