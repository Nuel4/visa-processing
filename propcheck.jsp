<%-- 
    Document   : propcheck.jsp
    Created on : 5 Mar, 2019, 12:58:40 PM
    Author     : Admin
--%>
...
if(rs.next())
{
    ...
    {
        out.println("<b>Offer Declined!. Application Rejected.</b>"); 
    }
    else
        if(status.equals("processing"))
        {
             out.println("<b>Offer is under process!. submit later.</b>");
        }
    else
        {
